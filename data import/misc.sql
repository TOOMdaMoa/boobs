...
-- variant_data_params_RUNNER, variant_data_params_TYPE_OF_SHOES

-- sport= RUNNING SHOES, HALL SHOES,FITNESS SHOES, SPORTING, TENNIS SHOES
-- winter=WINTER BOOTS, ANKLE BOOTS, SNOWBOOTS, ANKLE WINTER, FELT BOOTS, BOOTS
-- trek=TREKING SHOES, BACKPACKING BOOTS, LOW TOURISTIC
-- letni=CROCS, SANDALS, FLIP-FLOPS, ESPADRILLE
-- kazdodenni=SPORT SHOES, SHOES, MOCCASINS
-- lodicky=HEELS
-- holinky=GUM BOOT
